...
public class CategoriaService {
	...
	private CategoriaDTO converterEntidadeParaDto(Categoria categoria) {
		...
		public Categoria saveCategoriaComFoto(String categoriaString, MultipartFile file) throws Exception {
	        ...
	        categoriaDB.setNomeImagem(categoriaDB.getIdCategoria() + "" + file.getOriginalFilename());
	        Categoria categoriaAtualizada = categoriaRepository.save(categoriaDB);

	        try {
	            arquivoService.criarArquivo(categoriaDB.getIdCategoria() + "" + file.getOriginalFilename(), file);
	        } catch (Exception e) {
